...
class Allocation(TimeStampedModel):
    ...
    def clean(self):
        ...
        if self.status.name in ALLOCATION_STATUSES["require_end_date"]:
        ...
        elif self.status.name in ALLOCATION_STATUSES["require_start_date"]:
...
class AllocationUser(TimeStampedModel):
    ...
    def is_active(self):
        ...
        return self.status.name == "Active" and self.allocation.status.name in ALLOCATION_STATUSES["user_is_active"]
