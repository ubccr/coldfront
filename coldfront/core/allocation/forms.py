...
class AllocationForm(forms.Form):
    ...
    def __init__(self, request_user, project_pk, *args, **kwargs):
        ...
        resources = Resource.objects.filter(
            Q(id__in=university_hpc.values_list("id", flat=True))
            | Q(id__in=school_resources.values_list("id", flat=True))
        )
        ...
        if user_query_set:
            ...
            self.fields[
                "users"
            ].help_text = "<br/>Select users in your project to add to this allocation."
        else:
        ...
        self.fields[
            "justification"
        ].help_text = "<br/>Justification for requesting this allocation."
