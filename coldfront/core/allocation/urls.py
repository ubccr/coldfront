...
urlpatterns = [
    ...
    path(
        "request-list",
        allocation_views.AllocationRequestListView.as_view(),
        name="allocation-request-list",
    ),
    path(
        "change-list",
        allocation_views.AllocationChangeListView.as_view(),
        name="allocation-change-list",
    ),
    path(
        "<int:pk>/renew",
        allocation_views.AllocationRenewView.as_view(),
    ...
    path(
        "<int:pk>/change-request",
        allocation_views.AllocationChangeView.as_view(),
    ...
    path(
        "<int:pk>/allocationnote/add",
        allocation_views.AllocationNoteCreateView.as_view(),
        name="allocation-note-add",
    ),
    path(
