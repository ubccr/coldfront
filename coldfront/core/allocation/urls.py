...
urlpatterns = [
    ...
    path('<int:pk>/edit-user/<int:userid>', allocation_views.AllocationEditUserView.as_view(),
         name='allocation-edit-user'),
    path('<int:pk>/edit-user-allocation-attributes/', allocation_views.AllocationUserAttributesEditView.as_view(),
         name='allocation-edit-user-allocation-attributes'),
    ...
    path('allocation-note/<int:pk>/update',
    ...
    path('allocation-invoice-list', allocation_views.AllocationInvoiceListView.as_view(),
     ...
     path('allocation-invoice-paid-list', allocation_views.AllocationInvoicePaidView.as_view(),
         name='allocation-invoice-paid-list'),
    ...
    path('allocation/<int:pk>/add-invoice-note',
         allocation_views.AllocationInvoiceNoteCreateView.as_view(), name='allocation-add-invoice-note'),
