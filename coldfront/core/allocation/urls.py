...
urlpatterns = [
    ...
    path('<int:pk>/secure-dir-add-users/',
         secure_dir_views.SecureDirManageUsersView.as_view(action='Add'),
         name='secure-dir-add-users'),
    path('<int:pk>/secure-dir-remove-users/',
         secure_dir_views.SecureDirManageUsersView.as_view(action='Remove'),
         name='secure-dir-remove-users'),
    path('secure-dir-add-users-request-list',
         secure_dir_views.SecureDirManageUsersRequestListView.as_view(completed=False, action='Add'),
         name='secure-dir-add-users-request-list'),
    path('secure-dir-add-users-request-list-completed',
         secure_dir_views.SecureDirManageUsersRequestListView.as_view(completed=True, action='Add'),
         name='secure-dir-add-users-request-list-completed'),
    path('secure-dir-remove-users-request-list',
         secure_dir_views.SecureDirManageUsersRequestListView.as_view(completed=False, action='Remove'),
         name='secure-dir-remove-users-request-list'),
    path('secure-dir-remove-users-request-list-completed',
         secure_dir_views.SecureDirManageUsersRequestListView.as_view(completed=True, action='Remove'),
         name='secure-dir-remove-users-request-list-completed'),
    path('<int:pk>/secure-dir-manage-user-update-status-<str:action>',
         secure_dir_views.SecureDirManageUsersUpdateStatusView.as_view(),
         name='secure-dir-manage-user-update-status'),
    path('<int:pk>/secure-dir-manage-user-complete-status-<str:action>',
         secure_dir_views.SecureDirManageUsersCompleteStatusView.as_view(),
         name='secure-dir-manage-user-complete-status'),
    path('<int:pk>/secure-dir-manage-user-deny-request-<str:action>',
