...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for name, attribute_type, has_usage, is_private, is_changeable in (
            # FASRC defaults
            ('Storage Quota (TB)', 'Float', True, False, True),
            ('Storage Quota (TiB)', 'Float', True, False, True),
            ('Quota_In_Bytes', 'Int', True, False, False),
            ('UseStarFishZone', 'Yes/No', False, True, False),
            ('Offer Letter', 'Float', False, True, False),
            ('RequiresPayment', 'Boolean', False, True, False),
            ('Offer Letter Code', 'Text', False, True, False),
            ('Expense Code', 'Text', False, True, False),
            ('Subdirectory', 'Text', False, False, False),
            ('Heavy IO',  'Yes/No', False, False, False),
            ('Mounted',  'Yes/No', False, False, False),
            ('High Security', 'Yes/No', False, False, False),
            ('DUA', 'Yes/No', False, False, False),
            ('External Sharing', 'Yes/No', False, False, False),
            ...
            ('Core Usage (Hours)', 'Float', True, False, False),
