...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        lab_list = ["zhuang_lab", "moorcroft_lab", "kuang_lab", "kovac_lab", "holman_lab", "giribet_lab", "edwards_lab", "denolle_lab", "wofsy_lab"]
        for lab_name in lab_list:
            ...
            file_path = os.path.join(base_dir, 'local_data/holylfs04_old', file_name)
