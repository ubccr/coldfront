...
def funding_agency_mapper(funding_agency):
    agency_mapping = {
            'AHA': 'Other',
    ...
    if(funding_agency not in agency_mapping):
...
def import_grant(filename):
    with open(filename, 'r') as fp:
        ...
        for line in f:
            ...
            funding_agency_obj=funding_agency_mapper(funding_agency)
