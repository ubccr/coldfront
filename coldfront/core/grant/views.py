...
class GrantCreateView(LoginRequiredMixin, UserPassesTestMixin, FormView):
    ...
    def test_func(self):
        ...
        messages.error(
            self.request,
            "You do not have permission to add a new grant to this project.",
        )
...
class GrantUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    def test_func(self):
        ...
        messages.error(
            self.request,
            "You do not have permission to update grant from this project.",
        )
...
class GrantDeleteGrantsView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def test_func(self):
        ...
        messages.error(
            self.request,
            "You do not have permission to delete grants from this project.",
        )
