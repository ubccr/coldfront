...
urlpatterns = [
    ...
    path(
        "<int:pk>/remove-users/",
        project_views.ProjectRemoveUsersView.as_view(),
    ...
    path(
        ...
        project_views.ProjectReviewEmailView.as_view(),
        name="project-review-email",
    ),
    path(
        "<int:pk>/projectnote/add",
        project_views.ProjectNoteCreateView.as_view(),
