...
class ProjectReviewView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if 'We do not have information about your research. Please provide a detailed description of your work and update your school. Thank you!' in project_obj.description:
            messages.error(
