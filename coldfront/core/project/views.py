...
class ProjectArchiveProjectView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # project signals
        project_archive.send(sender=self.__class__,project_pk=project.pk)
...
class ProjectCreateView(LoginRequiredMixin, UserPassesTestMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        # project signals
        project_new.send(sender=self.__class__, project_pk=project_obj.pk)
...
class ProjectUpdateView(SuccessMessageMixin, LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_success_url(self):
        # project signals
        project_update.send(sender=self.__class__, project_pk=self.object.pk)
        return reverse('project-detail', kwargs={'pk': self.object.pk})
