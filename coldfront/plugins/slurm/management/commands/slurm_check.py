    ...
    def remove_user(self, user, account, cluster):
        ...
        if self.sync:
            try:
                ...
                logger.error(
                    "Failed removing Slurm association user %s account %s cluster %s: %s",
                    user,
                    account,
                    cluster,
                    e,
                ...
                logger.error(
                    "Removed Slurm association user %s account %s cluster %s successfully",
                    user,
                    account,
                    cluster,
                )
    ...
    def remove_account(self, account, cluster):
        ...
        if self.sync:
            try:
                ...
                logger.error(
                    "Failed removing Slurm account %s cluster %s: %s",
                    account,
                    cluster,
                    e,
                )
    ...
    def remove_qos(self, user, account, cluster, qos):
        ...
        if self.sync:
            try:
                ...
                logger.error(
                    "Failed removing Slurm qos %s for user %s account %s cluster %s: %s",
                    qos,
                    user,
                    account,
                    cluster,
                ...
                logger.error(
                    "Removed Slurm qos %s for user %s account %s cluster %s successfully",
                    qos,
                    user,
                    account,
                    cluster,
                ...
                for uid, user in account.users.items():
                    ...
                    if uid not in cluster_b.accounts[name].users:
                        ...
                        self._diff_qos(
                            ...
                            cluster_a.name,
                            user,
                            cluster_b.accounts[name].users[uid],
                        )
