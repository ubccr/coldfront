...
from coldfront.plugins.rest_api.views import SLURMAccountsAPI, SLURMAccountsPublicAPI, show_auth_code
...
urlpatterns = [
    ...
    path('public/slurm/<str:username>/', SLURMAccountsPublicAPI.as_view(), name='user-slurm-accounts-public'),
