...
def xdmod_fetch_total_cpu_hours(
    start, end, account, resources=None, statistics="total_cpu_hours"
):
...
def xdmod_fetch_total_storage(
    start, end, account, resources=None, statistics="physical_usage"
):
    if resources is None:
        resources = []
