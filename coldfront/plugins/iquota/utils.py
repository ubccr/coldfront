...
class Iquota:
    ...
    def get_user_quota(self):
        ...
        url = "https://{}:{}/quota?user={}".format(
            self.IQUOTA_API_HOST, self.IQUOTA_API_PORT, self.username
        )
    ...
    def _get_group_quota(self, group):
        ...
        url = "https://{}:{}/quota?group={}".format(
            self.IQUOTA_API_HOST, self.IQUOTA_API_PORT, group
        )
        ...
        for q in usage:
            ...
            quotas.append(
                self._humanize_group_quota(q["path"], group_used, group_limit)
            )
