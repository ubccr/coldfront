...
EMAIL_PROJECT_EXPIRING_NOTIFICATION_DAYS = ENV.list('EMAIL_PROJECT_EXPIRING_NOTIFICATION_DAYS', cast=int, default=[7, 14, 30])
...
EMAIL_GROUP_TO_EMAIL_MAPPING = ENV.dict('EMAIL_GROUP_TO_EMAIL_MAPPING', default={})
EMAIL_ALERTS_EMAIL_ADDRESS = ENV.str('EMAIL_ALERTS_EMAIL_ADDRESS', default='')
