...
# Whether to add parent organizations to user when populating 
# Organizations from LDAP.  Boolean. (use 1/0 for env vars)
ORGANIZATION_LDAP_USER_ADD_PARENTS = ENV.str(
    'ORGANIZATION_LDAP_USER_ADD_PARENTS', False)
