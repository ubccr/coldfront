...
# ------------------------------------------------------------------------------
AUTH_COLDFRONT_LDAP_SEARCH_SCOPE = ENV.str(
    "AUTH_COLDFRONT_LDAP_SEARCH_SCOPE", default="ONELEVEL"
)
...
if AUTH_COLDFRONT_LDAP_SEARCH_SCOPE == "SUBTREE":
    AUTH_LDAP_USER_SEARCH = LDAPSearch(
        AUTH_LDAP_USER_SEARCH_BASE, ldap.SCOPE_SUBTREE, "(uid=%(user)s)"
    )
    AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
        AUTH_LDAP_GROUP_SEARCH_BASE, ldap.SCOPE_SUBTREE, "(objectClass=groupOfNames)"
    )
else:
    AUTH_LDAP_USER_SEARCH = LDAPSearch(
