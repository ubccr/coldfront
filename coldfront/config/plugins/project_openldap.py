...
PROJECT_OPENLDAP_CONNECT_TIMEOUT = ENV.float(
    "PROJECT_OPENLDAP_CONNECT_TIMEOUT", default=2.5
)
...
PROJECT_OPENLDAP_OU = ENV.str(
    "PROJECT_OPENLDAP_OU", default=""
)  # where projects will be stored
