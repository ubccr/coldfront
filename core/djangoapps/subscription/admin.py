...
class SubscriptionAdmin(admin.ModelAdmin):
    ...
    fields_change = ('project', 'resources', 'quantity', 'justification', 'status', 'active_until', 'created', 'modified',)
    list_display = ('pk', 'project_title', 'project_pi', 'resource', 'quantity', 'justification', 'active_until', 'status', 'created', 'modified', )
    inlines_change = [SubscriptionUserInline, CommentInline]
    list_filter = ('resources__resource_type__name', 'status', 'resources__name', )
    search_fields = ['project__title', 'project__pi__username', 'project__pi__first_name', 'project__pi__last_name', 'resources__name', 'subscriptionuser__user__first_name', 'subscriptionuser__user__last_name', 'subscriptionuser__user__username']
...
class SubscriptionAttributeAdmin(admin.ModelAdmin):
    ...
    list_display = ('pk', 'project', 'pi', 'resource', 'subscription_status', 'subscription_attribute_type', 'value', 'usage', 'is_private', 'created', 'modified',)
...
class SubscriptionUserAdmin(admin.ModelAdmin):
    ...
    list_display = ('pk', 'project', 'project_pi', 'resource', 'subscription_status', 'user_info', 'status', 'created', 'modified',)
